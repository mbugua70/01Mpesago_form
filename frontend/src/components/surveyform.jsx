...
const SurveyForm = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (response) {
        toast.success("Your data have been submitted successfully!", {
          position: "top-center",
        });
  ...
  if (isOnline) {
    content = (
      <>
        {" "}
        <div className="card-panels card-relative">
          <form
            className="form"
            id="form"
            method="post"
    ...
    return <ErrorBlock title="500" message="Please check your internet" />;
  }
